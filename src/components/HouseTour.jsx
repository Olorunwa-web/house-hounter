            ...
            <div className='flex md:flex-row flex-col gap-y-9 justify-between w-full h-full items-center'>
                <div className='w-full basis-1/2'>
                   ...
                   <div className='mt-3 pl-10'>
                      <h1 className='mb-3 text-[#1B1C57] font-semibold text-xl lg:text-2xl'>Let's Tour And See Our House!</h1>
                      <p className='lg:w-[400px] text-[#626687] text-sm font-normal  '>Houses recommended by our partners that have been curated to become the home of your dreams!</p>
                      <div className='mt-4'>
                        ...
                        <div className='flex lg:flex-row flex-col  gap-x-10 gap-y-7 items-start lg:items-center'>
                          ...
                          <button className='flex items-center gap-2 px-4 py-3 bg-[#10B981] rounded-3xl'>
                ...
                <div className='w-full relative basis-1/2 lg:basis-2/3'>  
